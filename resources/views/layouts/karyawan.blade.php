...
<div class="d-flex">
    <aside class="app-aside">
        ...
        <nav class="aside-nav">
            ...
            <a class="nav-link {{ request()->routeIs('karyawan.cuti.ajukan') ? 'active' : '' }}"
               href="{{ route('karyawan.cuti.ajukan') }}">
                <i class="fa-solid fa-plane-departure"></i> Ajukan Cuti
            </a>

            <a class="nav-link {{ request()->routeIs('karyawan.cuti.riwayat') ? 'active' : '' }}"
               href="{{ route('karyawan.cuti.riwayat') }}">
    ...
    <main class="app-main flex-grow-1">
        <header class="app-topbar">
            <div class="topbar-title">{{ $title ?? 'Karyawan' }}</div>
            <div class="topbar-user">
                <div class="user-avatar">
                    {{ strtoupper(substr(auth()->user()->name ?? 'K', 0, 1)) }}
                </div>
                <div class="user-info">
                    <div class="user-name">{{ auth()->user()->name ?? 'Karyawan' }}</div>
                    <div class="user-role">{{ auth()->user()->division ?? 'Staff' }}</div>
                </div>
            </div>
        </header>
