...
<div class="review-container">
    <div class="review-card">
        ...
        <div class="card-header-bg">
            <div class="user-profile">
                ...
                <div class="user-details">
                    ...
                    <p>{{ $leave->user->division ?? 'Karyawan' }} &bull; Pengajuan Cuti</p>
                </div>
            </div>
        </div>
                ...
                <div class="info-item">
                    ...
                    <div>
                        <span class="status-badge" style="background: rgba(245, 158, 11, 0.1); color: #d97706; border: 1px solid rgba(245, 158, 11, 0.2);">
                            <i class="fa-solid fa-clock"></i> {{ ucfirst($leave->status) }}
                        </span>
                    </div>
                </div>
                <div class="info-item">
        ...
        <div class="action-area">
            <form action="{{ route('admin.cuti.process', $leave) }}" method="POST" class="action-form">
                @csrf
                ...
                <div class="btn-group-custom">
                    <a href="{{ route('admin.cuti.index') }}" class="btn-custom btn-back">
