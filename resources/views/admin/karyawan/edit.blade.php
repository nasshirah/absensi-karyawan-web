...
<div class="card border-0 shadow-sm">
  <div class="card-body">
    ...
    <form action="{{ route('admin.karyawan.update', $user) }}" method="POST" class="row g-3">
      @csrf
      @method('PUT')
      <div class="col-md-6">
      ...
      <div class="col-md-4">
        ...
        <input type="date" name="join_date" class="form-control" value="{{ old('join_date', $user->join_date) }}">
      </div>
      <div class="col-md-4">
        <label class="form-label">Status</label>
        <input type="text" name="status" class="form-control" value="{{ old('status', $user->status) }}" placeholder="Aktif / Nonaktif">
      </div>
