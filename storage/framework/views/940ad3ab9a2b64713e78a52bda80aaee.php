...
<head>
    ...
    <title><?php echo e($title ?? 'Admin'); ?> · Absensi Karyawan</title>
...
<div class="d-flex">
    <aside class="app-aside">
        ...
        <nav class="aside-nav">
            ...
            <a class="nav-link <?php echo e(request()->routeIs('admin.karyawan.*') ? 'active' : ''); ?>"
               href="<?php echo e(route('admin.karyawan.index')); ?>">
                <i class="fa-solid fa-users"></i> Data Karyawan
            </a>

            <a class="nav-link <?php echo e(request()->routeIs('admin.absensi.*') ? 'active' : ''); ?>"
               href="<?php echo e(route('admin.absensi.index')); ?>">
                <i class="fa-solid fa-clipboard-user"></i> Data Absensi
            </a>

            <div class="nav-section-title">Cuti Management</div>

            <a class="nav-link <?php echo e(request()->routeIs('admin.cuti.approval') ? 'active' : ''); ?>"
               href="<?php echo e(route('admin.cuti.approval')); ?>">
                <i class="fa-solid fa-square-check"></i> Persetujuan Cuti
            </a>

            <a class="nav-link <?php echo e(request()->routeIs('admin.cuti.index') ? 'active' : ''); ?>"
               href="<?php echo e(route('admin.cuti.index')); ?>">
    ...
    <main class="app-main flex-grow-1">
        <header class="app-topbar">
            <div class="topbar-title"><?php echo e($title ?? 'Admin'); ?></div>
...
</html><?php /**PATH C:\laragon\www\Absensi_Karyawan\resources\views/layouts/metronic.blade.php ENDPATH**/ ?>