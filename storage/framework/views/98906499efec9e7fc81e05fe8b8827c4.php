...
<div class="dashboard-container">
    ...
    <div class="welcome-header animate-up">
        ...
        ?>
        <h1 class="welcome-title"><?php echo e($greeting); ?>, <span class="welcome-name"><?php echo e(Auth::user()->name); ?></span>!</h1>
        <p class="welcome-subtitle">
            <i class="fa-regular fa-calendar me-2"></i><?php echo e(\Carbon\Carbon::now()->translatedFormat('l, d F Y')); ?>
    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-lg-5 animate-up" style="animation-delay: 0.1s;">
            ...
            ?>
            <div class="status-card <?php echo e($statusClass); ?>">
                <div class="status-icon-wrapper <?php echo e($iconClass); ?>">
                    <i class="fa-solid <?php echo e($statusIcon); ?>"></i>
                </div>
                <div>
                    <div class="status-label">Status Absensi Hari Ini</div>
                    <div class="status-value"><?php echo e($statusText); ?></div>
                    
                    <?php if($attendanceToday): ?>
                        <div class="mt-3">
                            <div class="time-badge">
                                <i class="fa-solid fa-arrow-right-to-bracket text-success"></i>
                                Masuk: <?php echo e(\Carbon\Carbon::parse($attendanceToday->check_in)->format('H:i')); ?>

                            </div>
                            <?php if($attendanceToday->check_out): ?>
                                <div class="time-badge ms-2">
                                    <i class="fa-solid fa-arrow-right-from-bracket text-danger"></i>
                                    Pulang: <?php echo e(\Carbon\Carbon::parse($attendanceToday->check_out)->format('H:i')); ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="mt-4">
                            <a href="<?php echo e(route('karyawan.absensi.index')); ?>" class="btn btn-primary rounded-pill px-4 fw-bold shadow-sm">
        ...
        <div class="col-lg-7">
            <div class="row g-3">
                ...
                <div class="col-md-6 animate-up" style="animation-delay: 0.2s;">
                    <a href="<?php echo e(route('karyawan.absensi.index')); ?>" class="action-card">
                ...
                <div class="col-md-6 animate-up" style="animation-delay: 0.3s;">
                    <a href="<?php echo e(route('karyawan.cuti.ajukan')); ?>" class="action-card">
                ...
                <div class="col-md-6 animate-up" style="animation-delay: 0.4s;">
                    <a href="<?php echo e(route('karyawan.absensi.riwayat')); ?>" class="action-card">
                ...
                <!-- Riwayat Cuti -->
                 <div class="col-md-6 animate-up" style="animation-delay: 0.5s;">
                    <a href="<?php echo e(route('karyawan.cuti.riwayat')); ?>" class="action-card">
...
<?php echo $__env->make('layouts.karyawan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Absensi_Karyawan\resources\views/karyawan/dashboard.blade.php ENDPATH**/ ?>