...
<div class="form-container">
    <div class="form-card">
        ...
        <div class="card-body-custom">
            ...
            <form method="POST" action="<?php echo e(route('karyawan.cuti.store')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="d-flex align-items-center justify-content-between mt-5 pt-3 border-top">
                    <a href="<?php echo e(route('karyawan.cuti.riwayat')); ?>" class="btn-history">
...
<?php echo $__env->make('layouts.karyawan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Absensi_Karyawan\resources\views/karyawan/cuti/ajukan.blade.php ENDPATH**/ ?>