...
<div class="profile-container">
    <div class="profile-card">
        ...
        <div class="avatar-wrapper">
            ...
            <div class="user-name-display"><?php echo e($user->name); ?></div>
            <div class="user-role-display">
                <i class="fa-solid fa-id-badge me-1"></i> <?php echo e($user->division ?? 'Karyawan'); ?>

            </div>
        </div>

        <div class="form-section">
            <form method="POST" action="<?php echo e(route('karyawan.profil.update')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control-custom" value="<?php echo e(old('name', $user->name)); ?>" required placeholder="Masukkan nama lengkap">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control-custom" value="<?php echo e($user->email); ?>" disabled style="padding-left: 2.5rem;">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="phone" class="form-control-custom" value="<?php echo e(old('phone', $user->phone)); ?>" placeholder="+62...">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="division" class="form-control-custom" value="<?php echo e(old('division', $user->division)); ?>" placeholder="Contoh: IT, HRD, Marketing">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label-custom">Jabatan</label>
                        <input type="text" name="position" class="form-control-custom" value="<?php echo e(old('position', $user->position)); ?>" placeholder="Contoh: Staff, Supervisor">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.karyawan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Absensi_Karyawan\resources\views/karyawan/profil.blade.php ENDPATH**/ ?>