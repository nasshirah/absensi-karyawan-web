...
<div class="premium-container">
    ...
    <div class="d-flex flex-column gap-3">
        <?php if(isset($items) && $items->count() > 0): ?>
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="data-card animate-item" style="animation-delay: <?php echo e($index * 0.1); ?>s">
                    ...
                    <div class="card-grid">
                        ...
                        <div class="user-info">
                            ...
                            <div>
                                <div class="data-value"><?php echo e($leave->user->name); ?></div>
                                <div class="text-muted small"><?php echo e($leave->user->division ?? 'Staff'); ?></div>
                            </div>
                        </div>

                        <!-- Type -->
                        <div>
                            <span class="badge bg-light text-dark border"><?php echo e(ucfirst($leave->type)); ?></span>
                        </div>

                        <!-- Period -->
                        <div>
                            <div class="data-value"><?php echo e($leave->start_date->format('d M Y')); ?></div>
                            <div class="text-xs text-muted">s/d <?php echo e($leave->end_date->format('d M Y')); ?></div>
                        </div>

                        <!-- Days -->
                        <div>
                            <span class="fw-bold fs-5 text-dark"><?php echo e($leave->days); ?></span> <span class="text-muted small">hari</span>
                        </div>

                        <!-- Reason -->
                        <div>
                            <div class="text-muted small fst-italic text-truncate" title="<?php echo e($leave->reason); ?>" style="max-width: 200px;">
                        ...
                        <div class="text-end d-flex gap-2 justify-content-end">
                            <a href="<?php echo e(route('admin.cuti.review', $leave)); ?>" class="btn-review">
...
<?php echo $__env->make('layouts.metronic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Absensi_Karyawan\resources\views/admin/cuti/pending.blade.php ENDPATH**/ ?>