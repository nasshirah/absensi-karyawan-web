...
<div class="history-container">
    <div class="page-header">
        ...
        <a href="<?php echo e(route('karyawan.cuti.ajukan')); ?>" class="btn-create">
    ...
    <?php else: ?>
        <div class="text-center py-5">
            ...
            <a href="<?php echo e(route('karyawan.cuti.ajukan')); ?>" class="btn-create mt-3 d-inline-block">Mulai Ajukan</a>
        </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.karyawan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Absensi_Karyawan\resources\views/karyawan/cuti/riwayat.blade.php ENDPATH**/ ?>